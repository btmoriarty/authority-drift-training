...
from authority_drift_training.exceptions import (
...
class ApiRequester:
    ...
    def __init__(self, timeout: int, retry: bool = True) -> None:
        '''
    ...
    async def get_data_async(
        ...
        return await self._get_data_async.retry_with(  # type: ignore[attr-defined, no-any-return]
    ...
    async def _get_data_async(
        ...
        curl_cmd = self._curl_cmd(url, parameters, method, headers, payload)
